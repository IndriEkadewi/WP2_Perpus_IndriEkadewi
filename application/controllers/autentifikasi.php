...
$this->form_validation->set_ruless('email', 'Alamat Email', 'required|trim|valid_email|is_unique[user.email]', [
         'valid_email' => 'Email Tidak Benar!!',
...
Password', 'required|trim|matches[password1]');
        ...
        //diinput akan disimpan ke dalam tabel use
        if ($this->form_validation->run() == false) {
